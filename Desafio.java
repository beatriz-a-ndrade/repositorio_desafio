 ...
 * Desafio de Programação Capgamini expressos como métodos 
 * static. A intenção é facilitar os testes desses algoritmos.
 * 
 * Questão 01: Esta questão é resolvida pelo método 'imprime_escada' (ver documentação desse método abaixo);
 * Questão 02: Esta questão é resolvida pelo método 'n_para_senha_segura' (ver documentação desse método abaixo);
 * Questão 03: Esta questão é resolvida pelo método 'num_pares_anagramas' (ver documentação desse método abaixo);
 * 
 */
